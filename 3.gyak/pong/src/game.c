...
//set radius
            case SDL_SCANCODE_Q:
                set_radius_ball_to(&(game->pong), game->pong.ball.radius+5,10,100);
                break;
            case SDL_SCANCODE_E:
                set_radius_ball_to(&(game->pong), game->pong.ball.radius-5,10,100);
                break;
...
/*
void init_point(Game* game){
    char str[10];
        sprintf(str, "%d - %d", game->pong.left_pad_counter, game->pong.right_pad_counter);
}
*/